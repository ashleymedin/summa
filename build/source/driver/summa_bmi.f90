...
! https://github.com/NOAA-OWP/ngen
  ...
  contains
   ...
   function summa_bmi_initialize_core(this, config_file, comm, rank, size, toml_file) result (bmi_status)
     ...
     this%model%summa1_struc(n)%domain_parallel%comm = comm
     this%model%summa1_struc(n)%domain_parallel%rank = rank
     this%model%summa1_struc(n)%domain_parallel%size = size
