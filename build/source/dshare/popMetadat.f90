...
subroutine popMetadat(err,message)
  ...
  prog_meta(iLookPROG%glacMass4AreaChange)             = var_info('glacMass4AreaChange'            , 'since updateJulDay mean rate glacier layers together mass change'        , 'kg m-2 s-1'      , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  ...
  indx_meta(iLookINDEX%nSnLaSoIcNrg)          = var_info('nSnLaSoIcNrg'         , 'number of energy states in the layer domains'                            , '-', get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  ...
  indx_meta(iLookINDEX%nSnLaSoIcHyd)          = var_info('nSnLaSoIcHyd'         , 'number of hydrology states in the layer domains'                         , '-', get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  ...
  indx_meta(iLookINDEX%ixSnLaSoIcNrg)         = var_info('ixSnLaSoIcNrg'        , 'indices IN THE STATE SUBSET for energy states in the layer domains'      , '-', get_ixVarType('midToto'), iMissVec, iMissVec, .false.)
  ...
  indx_meta(iLookINDEX%ixSnLaSoIcHyd)         = var_info('ixSnLaSoIcHyd'        , 'indices IN THE STATE SUBSET for hydrology states in the layer domains'   , '-', get_ixVarType('midToto'), iMissVec, iMissVec, .false.)
