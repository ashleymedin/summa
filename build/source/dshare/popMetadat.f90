...
subroutine popMetadat(err,message)
  ...
  mpar_meta(iLookPARAM%debris_runoff_shape)            = var_info('debris_runoff_shape'            , 'shape for runoff generation'                                      , '-'               , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  mpar_meta(iLookPARAM%debris_runoff_max)              = var_info('debris_runoff_max'              , 'maximum time scale for runoff generation'                         , 's'               , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  ...
  flux_meta(iLookFLUX%mLayerDebrisRunoff)              = var_info('mLayerDebrisRunoff'             , 'debris runoff from each soil layer'                               , 'm s-1'           , get_ixVarType('midSoil'), iMissVec, iMissVec, .false.)
  flux_meta(iLookFLUX%scalarDebrisRunoff)              = var_info('scalarDebrisRunoff'             , 'total debris runoff from the soil profile'                        , 'm s-1'           , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  ! derived variables
  ...
  deriv_meta(iLookDERIV%mLayerdDebrisRun_dTk)          = var_info('mLayerdDebrisRun_dTk'         , 'derivative in the soil layer debris runoff w.r.t. temperature'              ,  'm s-1 K-1' ,get_ixVarType('midSoil'), iMissVec, iMissVec, .false.)
  deriv_meta(iLookDERIV%mLayerdDebrisRun_dPsi0)        = var_info('mLayerdDebrisRun_dPsi0'       , 'derivative in the soil layer debris runoff w.r.t. total water matric potential',    's-1 ' ,get_ixVarType('midSoil'), iMissVec, iMissVec, .false.)
