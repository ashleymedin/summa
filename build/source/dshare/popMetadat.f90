...
subroutine popMetadat(err,message)
  ...
  flux_meta(iLookFLUX%scalarGlceInflux)                = var_info('scalarGlceInflux'               , 'influx to glacier ice, rain plus melt plus debri drainage'        , 'm s-1'           , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
