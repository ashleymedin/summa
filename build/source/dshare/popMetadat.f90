...
subroutine popMetadat(err,message)
  ...
  diag_meta(iLookDIAG%scalarSoilControlBot)            = var_info('scalarSoilControlBot'           , 'soil control on bottom melt infiltration for derivative'          , '-'               , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  ...
  flux_meta(iLookFLUX%scalarMeltInfiltration)          = var_info('scalarMeltInfiltration'         , 'infiltration of glacier meltwater into the soil profile'          , 'm s-1'           , get_ixVarType('scalarv'), iMissVec, iMissVec, .false.)
  ...
  deriv_meta(iLookDERIV%dq_dHydStateLayerBotVec)       = var_info('dq_dHydStateLayerBotVec'      , 'change in the flux in soil bottom interface w.r.t. state variables in layers','unknown'  , get_ixVarType('midSoil'), iMissVec, iMissVec, .false.)
  ...
  deriv_meta(iLookDERIV%dq_dNrgStateLayerBotVec)       = var_info('dq_dNrgStateLayerBotVec'      , 'change in the flux in soil bottom interface w.r.t. state variables in layers','unknown'  , get_ixVarType('midSoil'), iMissVec, iMissVec, .false.)
